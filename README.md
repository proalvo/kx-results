...
4. Start the software `ǹode server.js`. This creates an empty database for the competition - without rules (see installation step #7).
5. Open your web browser and enter `localhost:3000` as an address. Everything should look good now.
